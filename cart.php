...
<div class="col-md main-content">
    ...
    <h1>Shopping Cart</h1>
        <form action="index.php?page=cart" method="post">
            <table class="table table-striped table-dark fade-in">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <a href="index.php?page=cart&remove=<?=$product['id']?>" class="remove"><i>Remove</i></a>
                        </td>
            ...
            <div class="subtotal fade-in">
                <h3><span class="text">Subtotal</span>
                <span class="price">&dollar;<?=$subtotal?></span></h3>
            </div>
            <div class="buttons">
